...
if user_prompt:
    ...
    messages = [
        {"role": "system",
         "content": "You are MADDY whose task is to help students to understand a topic and will tell what will be the probable question that can come into my university semester exam and will also provide a cheatcode for remembering that topic in exam here are the details for chapters -This course covers fundamental concepts in communication systems, divided into six modules "
